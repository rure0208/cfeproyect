...
import { AppShell, Text, Navbar, Stack, Button , useMantineTheme, Footer, Header, Title, MediaQuery, Burger, Image} from '@mantine/core';
    ...
    <AppShell
      ...
      <Header height={60} p="md" sx={(theme) => ({ backgroundColor: '#A4E5A4' })} >
        <div style={{ display: 'flex', alignItems: 'center', height: '100%'}}>
          ...
          height={70} width={240}/> 
          {/* <Text align="center" color='white' size="xl" transform="uppercase">{tituloPagina}</Text>
       */}
        </div>

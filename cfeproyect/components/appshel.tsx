...
import { AppShell, Text, Navbar, Stack, Button , useMantineTheme, Footer, Header, Title, MediaQuery, Burger, Image,Group,Container} from '@mantine/core';
...
const AppShel = ({ children, tituloPagina }) => {
  ...
  return (
    <AppShell
      ...
      navbar={
      <Navbar style={{paddingTop: 20}}
        p="md" hiddenBreakpoint="sm" 
        hidden={!opened} width={{ sm: 200, lg: 250 }} sx={(theme) => ({ backgroundColor: '#A4E5A4' })}>
      ...
      header={<Header height={80} p="md" sx={(theme) => ({ backgroundColor: '#A4E5A4'})} >
        <div style={{ display: 'flex', alignItems: 'center', height: '100%'}}>
          ...
          height={70} width={280} style={{ marginLeft: 8}}/> 
          {/* <Container style={{ background: '#3F6D3F', width: 257, marginLeft: -5}}>
              <Text align='center'>Menu</Text>
          </Container> */}
         
          {/* </div> */}
          {/* <Container style={{ background: '#3F6D3F', width: 40000, marginLeft: -50, marginTop: 70}}>
              <Text align='center'>Menu</Text>
          </Container> */}
        </div>
